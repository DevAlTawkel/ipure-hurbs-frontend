...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="position-relative display-flex flex-direction-column overflow-hidden transition cursor-pointer ProductCard-container">
      ...
      <button
        ...
        className={`position-absolute border-none cursor-pointer transition border-radius-100 background-wk-200 ProductCard-wishlist-btn ${isWishlisted ? 'wishlisted' : ''}`}
      >
      ...
      <div className="position-relative display-flex align-items-center justify-content-center ProductCard-image-wrapper">
        <img
          src={product.image}
          alt={product.name}
      ...
      <div className="display-flex flex-direction-column flex-1 ProductCard-info">
        ...
        <div className="display-flex align-items-center justify-content-space-between ProductCard-price-row">
          <div>
            ...
            <span className="ProductCard-original-price">${product.originalPrice.toFixed(2)}</span>
          )} */}
          </div>
          <div className="display-flex align-items-center">
            <div className="display-flex align-items-center ProductCard-stars">
              <span className="manrope size-18 ProductCard-star-count">
                {product.rating}
              </span>
              {[1, 2, 3].map((star, i) => (
                // <Star
