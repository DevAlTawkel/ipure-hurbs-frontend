...
export default function ProductCard({ product }) {
  ...
  return (
    <Link href={`/products/${product.slug}`} prefetch={false}>
      <div className="position-relative display-flex flex-direction-column overflow-hidden transition cursor-pointer background-white-200 height-100 ProductCard-container">
        ...
        {/* Product info */}
        <div className="display-flex flex-direction-column justify-content-space-between height-100 ProductCard-info">
          ...
          <div className="display-flex flex-direction-column flex-1 ProductCard-info-sub">
            <div className="display-flex align-items-center justify-content-space-between ProductCard-price-row">
              <div>
                <span className="manrope size-24 font-600 ProductCard-price">{product.currency_symbol} {product.price.toFixed(2)}</span>
              </div>
