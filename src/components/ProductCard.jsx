...
export default function ProductCard({ product }) {
  ...
  const handleDecrease = () => {
    updateQuantity(product.id, quantity - 1);
    // toast is handled inside updateQuantity in the store
  };

  return (
    <div className="position-relative display-flex flex-direction-column overflow-hidden transition cursor-pointer background-white ProductCard-container">
