        ...
        <div className='position-relative HomeWhyChooseUs-main-container'>
            ...
            <div className='position-absolute HomeWhyChooseUs-content-container'>
                <div className='position-relative'>
                    ...
                    <div className='display-flex HomeWhyChooseUs-content-main-container'>
                        <div className='display-flex flex-direction-column HomeWhyChooseUs-content-main-left'>
                            <div className='HomeWhyChooseUs-card'>
                                <div className='display-flex gap-10 HomeWhyChooseUs-header-container'>
                                    <div className='display-flex align-items-center justify-content-center HomeWhyChooseUs-icon-container'>
                        ...
                        <div className='display-flex flex-direction-column HomeWhyChooseUs-content-main-right'>
                            <div className='HomeWhyChooseUs-card'>
                                <div className='display-flex gap-10 HomeWhyChooseUs-header-container'>
                                    <div className='display-flex align-items-center justify-content-center HomeWhyChooseUs-icon-container'>
