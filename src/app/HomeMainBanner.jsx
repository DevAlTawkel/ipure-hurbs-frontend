  ...
  return (
    <div className='position-relative HomeMainBanner-main-container'>
      ...
      <div className='position-absolute HomeMainBanner-content-container'>
        ...
        <div className="HomeMainBanner-button-wrap">
          <Link href="/products" className="background-deep-forest-green color-white text-align-center HomeMainBanner-button">
            <span className='position-relative text-align-center width-100 manrope font-600 size-24 color-white'>Explore More</span>
          </Link>
          <div className="HomeMainBanner-button-glow" />
        </div>
      </div>
    </div>
  )
